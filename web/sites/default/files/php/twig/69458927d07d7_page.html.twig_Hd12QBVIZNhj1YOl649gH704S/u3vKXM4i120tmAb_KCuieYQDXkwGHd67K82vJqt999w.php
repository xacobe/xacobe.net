...
/* themes/custom/icosaedrico/templates/layouts/page.html.twig */
class __TwigTemplate_e5421a5b147eed1e258e62d0ccd4efcc extends Template
{
...
<div class=\"page-wrapper ";
  ...
  <header role=\"banner\">
    ...
    ";
        // line 50
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "primary_menu", [], "any", false, false, true, 50), "html", null, true);
        yield "
    ";
        // line 51
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "secondary_menu", [], "any", false, false, true, 51), "html", null, true);
        yield "
  </header>
  ...
  <main role=\"main\" class=\"lg:px-24 md:px-8 px-4 pb-8\">
    ...
    ";
        // line 66
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_first", [], "any", false, false, true, 66)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 67
            yield "      <aside class=\"layout-sidebar-first\" role=\"complementary\">
        ";
            // line 68
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_first", [], "any", false, false, true, 68), "html", null, true);
            yield "
      </aside>
    ";
        }
    ...
    ";
        // line 72
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 72)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 73
            yield "      <aside class=\"layout-sidebar-second\" role=\"complementary\">
        ";
            // line 74
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 74), "html", null, true);
            yield "
      </aside>
    ";
        }
...
";
    ...
    {
        return "themes/custom/icosaedrico/templates/layouts/page.html.twig";
    }
    ...
    {
        return array (  131 => 87,  125 => 84,  116 => 77,  110 => 74,  107 => 73,  105 => 72,  102 => 71,  96 => 68,  93 => 67,  91 => 66,  86 => 64,  83 => 63,  76 => 58,  71 => 56,  66 => 54,  60 => 51,  56 => 50,  52 => 49,  47 => 47,  44 => 46,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/custom/icosaedrico/templates/layouts/page.html.twig", "/var/www/html/web/themes/custom/icosaedrico/templates/layouts/page.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["if" => 66];
        static $filters = ["escape" => 49, "date" => 87];
        static $functions = [];
